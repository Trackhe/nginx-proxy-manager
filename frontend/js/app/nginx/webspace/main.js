...
module.exports = Mn.View.extend({
    ...
    fetch: App.Api.Nginx.Webspaces.getAll,

    showData: function(response) {
        this.showChildView('list_region', new ListView({
            collection: new webspaceModel.Collection(response)
        }));
    },
    ...
    showEmpty: function() {
        let manage = App.Cache.User.canManage('webspaces');
    ...
    events: {
        ...
        'click @ui.help': function (e) {
            e.preventDefault();
            App.Controller.showHelp(App.i18n('webspaces', 'help-title'), App.i18n('webspaces', 'help-content'));
        },
    ...
    templateContext: {
        showAddButton: App.Cache.User.canManage('webspaces')
    },
