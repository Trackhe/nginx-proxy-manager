...
module.exports = Mn.View.extend({
    ...
    events: {
        'click @ui.able': function (e) {
            ...
            App.Api.Nginx.WebspaceHosts[this.model.get('enabled') ? 'disable' : 'enable'](id)
                .then(() => {
                    return App.Api.Nginx.WebspaceHosts.get(id)
                        .then(row => {
                            this.model.set(row);
                        });
                });
        ...
        'click @ui.edit': function (e) {
            e.preventDefault();
            App.Controller.showNginxWebspaceForm(this.model);
        },

        'click @ui.delete': function (e) {
            e.preventDefault();
            App.Controller.showNginxWebspaceDeleteConfirm(this.model);
        },
